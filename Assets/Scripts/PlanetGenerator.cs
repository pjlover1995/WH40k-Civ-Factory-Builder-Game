...
namespace WH40kCivFactoryBuilderGame
{
    ...
    public class PlanetGenerator : MonoBehaviour
    {
        ...
        private bool hasPendingEditorRegenerate;
...
#if UNITY_EDITOR
        private void QueueEditorRegenerate()
        {
            if (hasPendingEditorRegenerate)
            {
                return;
            }

            hasPendingEditorRegenerate = true;
            EditorApplication.delayCall += HandleEditorRegenerate;
        }

        private void HandleEditorRegenerate()
        {
            hasPendingEditorRegenerate = false;
            EditorApplication.delayCall -= HandleEditorRegenerate;
        ...
        private void CancelEditorRegenerate()
        {
            if (!hasPendingEditorRegenerate)
            {
                return;
